...
| config\_validator\_image\_tag | The tag of the Config Validator image to use | string | `"8f579ca"` | no |
...
| google\_cloud\_sdk\_version | Version of the Google Cloud SDK to install | string | `"293.0.0-0"` | no |
